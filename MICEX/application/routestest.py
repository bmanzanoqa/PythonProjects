...
@app.route('/jose', methods=['POST', 'GET'])
def jose():
    data = [
    ("Buildings & Wonders", "Some skylines & wonders of the world", "London", 14, "25-05-2021"),
    ("Animal Kingdom", "Our best friends", "Madrid", "12-11-2021", 7),
    ("Buildings & Wonders", "Some skylines & wonders of the world", "London", 14, "25-05-2021"),
    ("Animal Kingdom", "Our best friends", "Madrid", "12-11-2021", 7)
]
